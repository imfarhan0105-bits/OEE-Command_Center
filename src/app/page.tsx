...
import DowntimeGridSection from "@/components/sections/DowntimeGridSection";
...
export default async function Home() {
  const { companyOee, oeeMonthLabel, sector25Trend, sector69Trend, allPlantsLatest, allPlantsDowntimeLatest } =
  ...
  return (
    <main id="overview" className="bg-[var(--industrial-bg)] text-[var(--steel-light)]">
      ...
      <DowntimeGridSection serverDowntimeData={allPlantsDowntimeLatest} />
