...
export const PLANTS: Plant[] = [
  ...
  },
  {
    ...
    group: "sector-25",
    kind: "cnc",
    description: "High-speed CNC turning cells delivering precision components.",
  },
  {
    slug: "sector-25-vmc",
    name: "SECTOR 25 VMC",
    ...
    group: "sector-25",
    kind: "vmc",
    description: "VMCs executing complex multi-axis precision geometries.",
  },
  {
    ...
    group: "sector-69",
    kind: "cnc-vmc",
    description: "Block B integrated manufacturing environment with both, CNC turning and VMC machining capabilities.",
  },
  {
    ...
    group: "sector-69",
    kind: "cnc-vmc",
    description: "Block C integrated manufacturing environment with both, CNC turning and VMC machining capabilities.",
  },
  {
    ...
    group: "sector-69",
    kind: "cnc-vmc",
    description: "Block D integrated manufacturing environment with both, CNC turning and VMC machining capabilities.",
  },
  {
    slug: "sector-58",
    name: "SECTOR 58",
    ...
    group: "none",
    kind: "forging",
    description: "Heavy forging press facility producing high-tolerance steel components under extreme pressure and heat.",
  },
  {
    slug: "unit-94",
    name: "UNIT 94",
    ...
    group: "none",
    kind: "cnc-vmc",
    description: "Precision manufacturing cell with CNC and VMC machines for tight-tolerance component families.",
  },
  {
    slug: "unit-97",
    name: "UNIT 97",
    ...
    group: "none",
    kind: "cnc-vmc",
    description: "CNC and VMC machining environment supporting high-precision component operations.",
  },
];
